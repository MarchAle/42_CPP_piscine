...
/*   Updated: 2022/09/21 16:33:04 by amarchal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../incs/Form.hpp"

Form::Form() : name("unknown"), is_signed(0), grade_to_sign(1), grade_to_execute(1)
{
	std::cout << GREEN << "Default Form successfuly created" << END << std::endl;
}

Form::Form(const std::string name, const int grade_to_sign, const int grade_to_execute) : name(name), is_signed(0), grade_to_sign(grade_to_sign), grade_to_execute(grade_to_execute)
{
...
Form::Form(const Form &source) : name(source.name), is_signed(source.is_signed), grade_to_sign(source.grade_to_sign), grade_to_execute(source.grade_to_execute)
{
}
